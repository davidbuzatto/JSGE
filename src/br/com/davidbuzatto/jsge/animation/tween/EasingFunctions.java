...
public class EasingFunctions {
    ...
    public static DoubleFunction<Double> easeInExpo = ( x ) -> {
        return x == 0 ? 0 : Math.pow( 2, 10 * x - 10 );
    };

    public static DoubleFunction<Double> easeOutExpo = ( x ) -> {
        return x == 1 ? 1 : 1 - Math.pow( 2, -10 * x );
    };

    public static DoubleFunction<Double> easeInOutExpo = ( x ) -> {
        return x == 0
            ? 0
            : x == 1
                ? 1
    ...
    public static DoubleFunction<Double> easeInBounce = ( x ) -> {
        return 1 - EasingFunctions.easeOutBounce.apply( 1 - x );
    };
    ...
    public static DoubleFunction<Double> easeInOutBounce = ( x ) -> {
        return x < 0.5
            ? ( 1 - EasingFunctions.easeOutBounce.apply( 1 - 2 * x ) ) / 2
            : ( 1 + EasingFunctions.easeOutBounce.apply( 2 * x - 1 ) ) / 2;
    };
