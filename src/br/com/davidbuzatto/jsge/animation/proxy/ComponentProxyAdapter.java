 ...
 */
public class ComponentProxyAdapter<ComponentType> extends ComponentProxy<ComponentType> {
     ...
     */
    public ComponentProxyAdapter( ComponentType component ) {
        super( component );
    }
    ...
    @Override
    public void setStartRotation( double rotation ) {
        
    }

    @Override
    public void setEndRotation( double rotation ) {
    ...
    @Override
    public void setVelAngle( double angleVel ) {
        
    }

    @Override
    public void setVelRotation( double rotationVel ) {
        
    }

    @Override
    public void setVelScale( double scaleVel ) {
